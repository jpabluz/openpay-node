...
function Customers(baseData){
  ...
  this.charges = {
    create : function (customerId, data, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/charges',
        requestData: {method: 'POST', json: data},
        callback: callback
      }));
    },
    ...
    list : function (customerId, data, callback) {
      ...
      var callback = _.isFunction(callback) ? callback : _.isFunction(data) ? data : null;
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/charges' + query,
        requestData: {method: 'GET'},
        callback: callback
      }));
    },
    ...
    get : function (customerId, transactionId, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/charges/' + transactionId,
        requestData: {method: 'GET'},
        callback: callback
      }));
    },
    ...
    capture : function (customerId, transactionId, data, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/charges/' + transactionId + '/capture',
        requestData: {method: 'POST', json: data},
        callback: callback
      }));
    },
    ...
    refund : function (customerId, transactionId, data, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/charges/' + transactionId + '/refund', 
        requestData: {method: 'POST', json: data},
        callback: callback
      }));
    }
  ...
  this.transfers = {
    create : function (customerId, data, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/transfers', 
        requestData: {method: 'POST', json: data},
        callback: callback
      }));
    },
    ...
    list : function (customerId, data, callback) {
      ...
      var callback = _.isFunction(callback) ? callback : _.isFunction(data) ? data : null;
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/transfers' + query,
        requestData: {method: 'GET'},
        callback: callback
      }));
    },
    ...
    get : function (customerId, transactionId, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/transfers/' + transactionId,
        requestData: {method: 'GET'},
        callback: callback
      }));
    }
  ...
  this.payouts = {    
    create : function (customerId, data, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/payouts',
        requestData: {method: 'POST', json: data},
        callback: callback
      }));
    },
    ...
    list : function (customerId, data, callback) {
      ...
      var callback = _.isFunction(callback) ? callback : _.isFunction(data) ? data : null;
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/payouts' + query,
        requestData: {method: 'GET'},
        callback: callback
      }));
    },
    ...
    get : function (customerId, transactionId, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/payouts/' + transactionId,
        requestData: {method: 'GET'},
        callback: callback
      }));
    }
  ...
  this.subscriptions = {
    create : function (customerId, data, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/subscriptions',
        requestData: {method: 'POST', json: data},
        callback: callback
      }));
    },
    ...
    list : function (customerId, data, callback) {
      ...
      var callback = _.isFunction(callback) ? callback : _.isFunction(data) ? data : null;
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/subscriptions' + query,
        requestData: {method: 'GET'},
        callback: callback
      }));
    },
    ...
    get : function (customerId, subscriptionId, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/subscriptions/' + subscriptionId,
        requestData: {method: 'GET'},
        callback: callback
      }));
    },
  ...
  this.cards = {
    create : function (customerId, data, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/cards',
        requestData: {method: 'POST', json: data},
        callback: callback
      }));
    },
    ...
    list : function (customerId, data, callback) {
      ...
      var callback = _.isFunction(callback) ? callback : _.isFunction(data) ? data : null;
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/cards' + query,
        requestData: {method: 'GET'},
        callback: callback
      }));
    },
    ...
    get : function (customerId, cardId, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/cards/' + cardId,
        requestData: {method: 'GET'},
        callback: callback
      }));
    },
  ...
  this.bankaccounts = {
    create : function (customerId, data, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/bankaccounts', 
        requestData: {method: 'POST', json: data},
        callback: callback
      }));
    },
    ...
    list : function (customerId, data, callback) {
      ...
      var callback = _.isFunction(callback) ? callback : _.isFunction(data) ? data : null;
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/bankaccounts' + query, 
        requestData: {method: 'GET'},
        callback: callback
      }));
    },
    ...
    get : function (customerId, bankId, callback) {
      sendRequest(_.extend(baseData, {
        apiUrl: baseUrl + '/' + customerId + '/bankaccounts/' + bankId,
        requestData: {method: 'GET'},
        callback: callback
      }));
    },
